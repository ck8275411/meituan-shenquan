...
token = '_jn117l2hcKXXDH2YS6YcsXGVn0AAAAAoRQAAMMtvQcIHrHfBifsQWjYe9FkYlEOEGBCDAfo-0ldbzBmChyNVbTVLM_kUS_qK1REwA'
propId=int(os.environ.get("propId"))
exchangeCoinNumber=os.environ.get("exchangeCoinNumber")
serverkey = ''
pushPlusToken = '34ecf65da2a9422aa38e37902e220e28'
...
print("pushPlusToken=" + str(pushPlusToken))
##############################################################################
